...
module.exports = {
  ...
  notes: [
    ...
    'So a WEB-DERIVED key - and the vault, which derives over that route -',
    'is a different key after the upgrade: a vault written on v3.0.4 does not',
    'open on v3.0.5. SSH/GPG AGENT-derived keys do NOT move: the agent route',
